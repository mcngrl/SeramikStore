...
INSERT INTO [dbo].[Potansiyel] ([Id], [Name], [SurName], [KnownName], [Email], [PhoneNumber], [Adress], [tarih], [kayıttarihi], [OzelSaatBilgisi], [SatirAciklamasi], [GenisAciklama], [Fiyat], [InsertDate], [UpdateDate], [IsActive])
VALUES
(9, N'Has', N'Ali', N'veli', N'email@email.com', N'1', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, N'as', N'sa', N'as', N'sa', N'sa', 1, '2026-01-09T00:00:00', '2026-01-27T08:43:00', 12:00:00, N'12', N'1221', NULL, NULL, NULL, NULL),
(11, N'Atakan', N'Hazıt', N'NM', N'a@a.com', N'1523898008712', 1, '2026-01-27T00:00:00', '2026-01-29T14:08:00', 12:00:00, N'1', N'22', NULL, NULL, NULL, NULL),
(12, N'sa', N'sa', N'sa', N'sa', N'sa', 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-29T09:04:38', '2026-01-29T09:05:24', 1)
GO
...
IF OBJECT_ID('dbo.XERNOTNL', 'U') IS NOT NULL
    DROP TABLE [dbo].[XERNOTNL]
GO
CREATE TABLE [dbo].[XERNOTNL] (
   [Id] int IDENTITY(1,1) NOT NULL,
   ...
   [VarCharValue] varchar(100) NOT NULL,
   [VarCharMaxValue] varchar(MAX) NOT NULL,
   [NCharValue] nchar(10) NOT NULL,
   [NVarCharValue] nvarchar(100) NOT NULL,
   [NVarCharMaxValue] nvarchar(MAX) NOT NULL,
   [NTextValue] ntext NOT NULL,
   [BinaryValue] binary NOT NULL,
   [VarBinaryValue] varbinary NOT NULL,
   [VarBinaryMaxValue] varbinary NOT NULL,
   [ImageValue] image NOT NULL,
   [XmlValue] xml NOT NULL,
   [SqlVariantValue] sql_variant NOT NULL,
   [RowVersionValue] timestamp NOT NULL,
   [HierarchyIdValue] hierarchyid NOT NULL,
...
IF OBJECT_ID('dbo.XEROX', 'U') IS NOT NULL
    DROP TABLE [dbo].[XEROX]
GO
CREATE TABLE [dbo].[XEROX] (
   [Id] int IDENTITY(1,1) NOT NULL,
   [BigId] bigint NULL,
   [UniqueId] uniqueidentifier NULL,
   [IntValue] int NULL,
...
ALTER TABLE [dbo].[XEROX]
ADD CONSTRAINT [PK__XEROX__3214EC07CBDE23E1]
PRIMARY KEY CLUSTERED ([Id])
GO
