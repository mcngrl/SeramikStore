...
INSERT INTO [dbo].[Cart] ([Id], [ProductId], [ProductCode], [ProductName], [UnitPrice], [Quantity], [TotalAmount], [UserId])
VALUES
(3, 3, N'F02', N'Arnica', 7500.00, 1, 7500.00, 1),
(4, 3, N'F02', N'Arnica', 7500.00, 1, 7500.00, 1),
(10, 3, N'F02', N'Arnica', 7500.00, 1, 7500.00, 1),
(11, 3, N'F02', N'Arnica', 7500.00, 1, 7500.00, 1),
(2007, 3008, N'as', N'as', 243.00, 3, 729.00, 2),
(2009, 3020, N'11', N'11', 123.00, 1, 123.00, 2),
(3005, 3020, N'11', N'11', 123.00, 1, 123.00, 1002),
(3006, 3020, N'11', N'11', 123.00, 1, 123.00, 3),
(3007, 3008, N'as', N'as', 243.00, 33, 8019.00, 3),
(3008, 3008, N'as', N'as', 243.00, 32, 7776.00, 1002),
(3009, 3020, N'Hayal kahvesi', N'Hayal kahvesi', 123.00, 1, 123.00, 1004)
GO
...
CREATE TABLE [dbo].[OrderDetail] (
   ...
   [ProductName] nvarchar(1020) NULL,
...
CREATE TABLE [dbo].[Product] (
   [Id] int IDENTITY(1,1) NOT NULL,
   [ProductCode] nvarchar(200) NOT NULL,
   [ProductName] nvarchar(1020) NOT NULL,
...
INSERT INTO [dbo].[Product] ([Id], [ProductCode], [ProductName], [ProductDesc], [CategoryId], [UnitPrice], [CurrencyId], [AvailableForSale], [DisplayOrderNo], [testkol], [fgf], [dd], [ddff], [dddf])
VALUES
(3006, N'A05', N'İLİVA 6 Kişilik 12 Parça Modern Renkli Kahve Finca', N'İLİVA 6 Kişilik 12 Parça Modern Renkli Kahve Fincan Takımı - Şık Tasarım Sunum Seti
İLİVA Modern Renkli Seri
...
Zaman biraz yavaşlar.
İLİVA’da
Kahve, stile dönüşür.', 5, 8714.00, 1, 1, 4, NULL, NULL, NULL, NULL, NULL),
(3008, N'A04', N'WPAWZ Özel Tasarım Sevgililer Günü 2’li Evin Hanım', N'<ul><li><strong>Kahve köpüğünde saklı küçük mutluluklar,</strong></li><li><strong>Bir yudumda gülüş, bir yudumda anılar.</strong></li><li><strong>Sevgililer Günü’nde değil yalnız bugün,</strong></li><li><strong>Her sabah hatırlatır: “Bu evde sevgi hüküm sürer.”</strong></li><li><strong>İki fincan, tek kalp, paylaşılan bir ömür,</strong></li><li><strong>Sıcak bir kahve gibi… Aşk hep taze.</strong></li></ul>', 5, 10.00, 2, 1, 6, NULL, NULL, NULL, NULL, NULL),
...
Bir an durur zaman.
Love Bird’de
Kahve, biraz aşktır.', 3, 78545.00, 1, 1, 5, NULL, NULL, NULL, NULL, NULL),
...
Çay demlenir, zaman yavaşlar,
Beyaz fincanlarda mutluluk çoğalır. ☕🤍', 5, 5211.00, 1, 1, 7, NULL, NULL, NULL, NULL, NULL),
(3019, N'A02', N'ŞURAMUTFAK 12 Parça Fincan Takımı | 6 Kişilik Finc', N'<p>Detayları buraya </p><p>yazaıyorum</p><p><strong>Bold</strong></p><p><br></p><p><br></p><p><br></p>', 5, 960.00, 1, 1, 3, NULL, NULL, NULL, NULL, NULL),
...
Çay soğusa bile,
Anı sıcak kalır bu fincanda. 🌼☕', 5, 700.00, 1, 1, 8, NULL, NULL, NULL, NULL, NULL),
(3021, N'URN01024', N'Gelinlik Kahvesi', N'<ul><li><strong>Kahve köpüğünde saklı küçük mutluluklar,</strong></li><li><strong>Bir yudumda gülüş, bir yudumda anılar.</strong></li><li><strong>Sevgililer Günü’nde değil yalnız bugün,</strong></li><li><strong>Her sabah hatırlatır: “Bu evde sevgi hüküm sürer.”</strong></li><li><strong>İki fincan, tek kalp, paylaşılan bir ömür,</strong></li><li><strong>Sıcak bir kahve gibi… Aşk hep taze, hep dür.</strong></li></ul>', 5, 15200.00, 2, 1, 2, NULL, NULL, NULL, NULL, NULL),
(3022, N'dsaasd', N'sdasda', N'<p><strong>sdasdaads</strong></p>', 5, 2331.00, 2, 1, 9, NULL, NULL, NULL, NULL, NULL),
(3023, N'ABC', N'ACa111', N'<p><strong>assad</strong></p>', 3, 1.00, 3, 1, 1, NULL, NULL, NULL, NULL, NULL)
GO
...
CREATE TABLE [dbo].[ProductImage] (
   [Id] int IDENTITY(1,1) NOT NULL,
   [ProductId] int NOT NULL,
   [ImagePath] nvarchar(1020) NOT NULL,
   [IsMain] bit NOT NULL,
...
INSERT INTO [dbo].[User] ([Id], [FirstName], [LastName], [Email], [PasswordHash], [PhoneNumber], [BirthDate], [IsActive], [RoleId])
VALUES
(2, N'Can', N'Gürel', N'can@can.com', N'AQAAAAIAAYagAAAAEBya70l0CKcmEHi36ncLA0c71fjkaGcjNoORUXkUPyPc331zf6Q9RwTxsC1fbXNw8A==', N'05323869350', '1978-01-12T00:00:00', 1, 2),
(3, N'Ali', N'Yılmaz', N'ali@ali.com', N'AQAAAAIAAYagAAAAEP3iKykNTdS9SNbLVWGDxVMibz+Qd8LmSdovaTAVXRxE8DE419F7POxpG5o/4IFcBw==', N'025323869350', '2026-01-24T00:00:00', 1, 2),
(1002, N'Salih', N'Yurdagül', N'salih@salih.com', N'AQAAAAIAAYagAAAAEJ+OG7JjyoIfjGkZs3/y2DTebSFFg7PjvPbADcA3IegXTy2LSdCGuhazikPpyNsI4A==', N'321321', '2026-01-23T00:00:00', 1, 2),
(1003, N'Ayşe1', N'terele', N'ayse@ayse.com', N'AQAAAAIAAYagAAAAEJ+BlAJ3I7RWqQ+tALPHJtcOPEr3ki5fbcEDMBBUG4PRbc0FB/VIEqFCvPkZlZpgxw==', N'321321', '2026-01-23T00:00:00', 1, 2),
(1004, N'Elif', N'Elif', N'elif@elif.com', N'AQAAAAIAAYagAAAAEK9JmimSxi0iaBuh4xy29f4JFoYMOqjqIsxno2iWSFlQQq4u1E0UQDwvbIxMMg99vg==', N'5692151847', '2026-01-24T00:00:00', 1, 2),
(2003, N'Can', N'Gürel', N'admin@admin.com', N'AQAAAAIAAYagAAAAEBCwp9AumgSg+KAR1R4NO6yyz3Dh9O8h4TSv9okU1MDWU7uDmT00cMgYv+W6M0RsoA==', N'321321', '2027-01-01T00:00:00', 1, 1),
(2004, N'Ali', N'Veli', N'customer@customer.com', N'AQAAAAIAAYagAAAAEIfDOAtnAe0Y0ZCIgsJr/DvK5M8WbbfGGdyi5/mVzXCzJYNu2fZPDlfXVcm7CPVkDA==', N'32132', '2026-01-29T00:00:00', 1, 2)
GO
...
CREATE TABLE [dbo].[UserAddress] (
   [Id] int IDENTITY(1,1) NOT NULL,
   [UserId] int NOT NULL,
   [Ad] nvarchar(400) NULL,
   [Soyad] nvarchar(400) NULL,
   [Telefon] nvarchar(80) NULL,
   [Il] nvarchar(200) NULL,
   [Ilce] nvarchar(400) NULL,
   [Mahalle] nvarchar(400) NULL,
   [Adres] nvarchar(MAX) NULL,
   [Baslik] nvarchar(80) NULL,
   [IsDefault] bit NULL
)
GO
...
CREATE TABLE [dbo].[UserTable] (
   ...
   [Name] nvarchar(200) NULL,
   [TelephoneNumber] nvarchar(200) NULL,
