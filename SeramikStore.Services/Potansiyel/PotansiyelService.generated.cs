...
namespace SeramikStore.Services
{
    public partial class PotansiyelService : IPotansiyelService
    {
        ...
        public int Create(PotansiyelCreateDto dto)
        {
            ...
            cmd.Parameters.AddWithValue("@saat", (object?)dto.saat ?? DBNull.Value);
            cmd.Parameters.AddWithValue("@satir", (object?)dto.satir ?? DBNull.Value);
            cmd.Parameters.AddWithValue("@max", (object?)dto.max ?? DBNull.Value);
            cmd.Parameters.AddWithValue("@resim", (object?)dto.resim ?? DBNull.Value);
            conn.Open();
        ...
        public PotansiyelDto? GetById(int id)
        {
            ...
            return new PotansiyelDto
            {
                ...
                saat = rdr["saat"] == DBNull.Value ? (TimeOnly?)null : TimeOnly.FromTimeSpan((TimeSpan)rdr["saat"]),
                satir = rdr["satir"] == DBNull.Value ? (string?)null : (string)rdr["satir"],
                max = rdr["max"] == DBNull.Value ? (string?)null : (string)rdr["max"],
                resim = rdr["resim"] == DBNull.Value ? (byte[]?)null : (byte[])rdr["resim"],
            };
        }
